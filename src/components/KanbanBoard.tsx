  ...
  return (
    <div className="p-6 md:p-8 min-h-screen bg-background relative">
      ...
      <div className="fixed top-4 right-4 z-50">
        <div className="bg-transparent border-2 border-dashed border-purple-500 text-purple-600 text-xs px-3 py-1.5 rounded-full shadow-lg opacity-60 hover:opacity-90 transition-opacity duration-200 backdrop-blur-sm">
          developed by maggie
        </div>
      </div>
